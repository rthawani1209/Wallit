...
export function GoogleButton({ label }: { label: string }) {
  return (
    <a
      ...
      className="w-full inline-flex items-center justify-center gap-2.5 rounded-md border border-border bg-secondary px-4 py-2 text-sm font-medium text-foreground hover:bg-secondary/80 transition-colors"
    >
      <GoogleLogo />
      {label}
    </a>
